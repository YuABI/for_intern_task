      ...
      [
        ...
        [
          init_form(f, {
            ...
            input: f.select(:cache_income_kind, UserLifeplanIncome.cache_income_kind.values.map { |v| [v.text, v.value] }, {}, class: f.object.decorate.input_class(:cache_income_kind, :admin)),
            col: 6, no_required: false, help: '', alert: ''
          }),
        ],
        [
          init_form(f, {
            code: :pension_kind,
            input: f.select(:pension_kind, UserLifeplanIncome.pension_kind.values.map { |v| [v.text, v.value] }, {}, class: f.object.decorate.input_class(:pension_kind, :admin)),
            col: 6, no_required: false, help: '', alert: ''
          }),
        ],
        [
          init_form(f, {
            ...
            input: f.select(:user_lifeplan_income_kind, UserLifeplanIncome.user_lifeplan_income_kind.values.map { |v| [v.text, v.value] }, {}, class: f.object.decorate.input_class(:user_lifeplan_income_kind, :admin)),
            col: 6, no_required: false, help: '', alert: ''
          }),
        ],
        [
          init_form(f, {
            code: :content,
            input: f.text_field(:content, class: f.object.decorate.input_class(:content, :admin), placeholder: ''),
            col: 6, no_required: false, help: '', alert: ''
          }),
        ],
        [
