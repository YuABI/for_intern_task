...
(function () {
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            if (lang == 'en') {
                document.getElementById("header-lang-img").src = "so/assets/admin/flags/us.jpg";
            } else if (lang == 'sp') {
                document.getElementById("header-lang-img").src = "so/assets/admin/flags/spain.jpg";
            } else if (lang == 'gr') {
                document.getElementById("header-lang-img").src = "so/assets/admin/flags/germany.jpg";
            } else if (lang == 'it') {
                document.getElementById("header-lang-img").src = "so/assets/admin/flags/italy.jpg";
            } else if (lang == 'ru') {
                document.getElementById("header-lang-img").src = "so/assets/admin/flags/russia.jpg";
            }
    ...
    function changeDirection(id) {
        // if (document.getElementById("layout-direction-ltr").checked == true && id === "layout-direction-ltr") {
            ...
            // document.getElementById('bootstrap-style').setAttribute('href', 'so/assets/admin/dashonic/bootstrap.min.css');
            // document.getElementById('app-style').setAttribute('href', 'so/assets/admin/dashonic/app.min.css');
            sessionStorage.setItem("is_visited", "layout-direction-ltr");
        ...
        //     document.getElementById('bootstrap-style').setAttribute('href', 'so/assets/admin/dashonic/bootstrap-rtl.min.css');
        //     document.getElementById('app-style').setAttribute('href', 'so/assets/admin/dashonic/app-rtl.min.css');
