class Operation < Base::BasicActiveModel
  ...
  DATA_LIST = [
    ...
    { id: 400,  code: 'products',            operation_category_id: OperationCategory.plan.id },
    { id: 410,  code: 'product_options',     operation_category_id: OperationCategory.plan.id },
    ...
    { id: 520,  code: 'video_genres',       operation_category_id: OperationCategory.content.id },
    { id: 530,  code: 'video_tags',       operation_category_id: OperationCategory.content.id },
